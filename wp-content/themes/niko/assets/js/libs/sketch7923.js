(function ($, window, document, undefined) {
    ...
    var wrapper = document.querySelector('.site-content__animation');

    var options = {
        Background: wrapper.getAttribute('data-background-color'),
        Color1: wrapper.getAttribute('data-animation-color-1'),
        Color2: wrapper.getAttribute('data-animation-color-2'),
        Color3: wrapper.getAttribute('data-animation-color-3'),
        Length: 28,
        Nums: 100,
        MaxRadius: 1,
        MinRadius: 1,
